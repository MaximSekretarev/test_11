...
root.columnconfigure(0, minsize=180)

lab_text_colour = Label()
lab_text_colour.grid(column=0, row=0, sticky='ew')
emp_colour = Entry(justify=CENTER)
emp_colour.grid(column=0, row=1, sticky='ew')
...
for key in colour:
    ...
    button_colour.grid(column=0, row=i, sticky='ew')
    i += 1
